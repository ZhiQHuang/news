    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="ListNews?op=verify" method="post" id="myform" name="myform" enctype="multipart/form-data">
		...
		<ul class="forminfo">
			...
			<li><label>文章内容：</label> 
				...
				<input name="" type="submit" class="btn" value="审核通过" />
				<input name="" type="submit" class="btn" value="返回" onclick="javascript:location='ListNews?op=listNews'" >
				</li>
		</ul>
