...
<body>
						...
						<div class="collapse navbar-collapse"
							...
							<ul class="nav navbar-nav">
								...
								<c:forEach items="${classList }" var="c">
									<li class="divider"><a href="Front?op=listByClass&classId=${c.classId }">${c.content}</a></li>
								</c:forEach>
							</ul>
							<div class="search">
								<!-- start search-->
								<div class="search-box">
									<div id="sb-search" class="sb-search">
										<form action="Front?op=query" method="post">
											<input class="sb-search-input"  type="search" name="search" id="search" value="thissite" checked="checked">
										    <input class="sb-search-submit" type="submit" value="search"> 
										    <input type="text" name="q" size="10" id="searchfield" title="searchfield" />
									     	<span class="sb-icon-search"><img src="images/search.png" /></span>
										</form>
									</div>
								</div>
								<!-- search-scripts -->
	...
	<div class="wrap">
		<div class="move-text">
			...
			<div class="marquee">
				<div class="marquee1">
					<a class="breaking" href="single.html">>>${recentNews[0].headTitle}</a>
				</div>
				<div class="marquee2">
					<a class="breaking" href="single.html">>>${newsList1[0].headTitle }</a>
				</div>
				<div class="clearfix"></div>
			</div>
			<div class="clearfix"></div>
				...
				<div class="first_half">
                    ...
                    <c:forEach items="${classList }" var="c11" begin="2" varStatus="sta">
								...
								<label for="label-1" id="item1"><i class="ferme"></i>
									<a href="#" rel="${c11.content }" style="text-decoration:none;color:#E1E6F4"
                    	     		<c:if test="${sta.index==1 }">class="selected"</c:if> >
                    					${c11.content }</a>
                    					<i class="icon-minus-sign i-right2"></i></label> 
                    </c:forEach>
								<div class="content" id="a1">
								<c:forEach items="${newsList2 }" var="l2" varStatus="sta1">
									<div class="scrollbar" id="style-2">
										<div class="force-overflow">
										<c:forEach items="${l2 }" begin="3" var="news2">
											<div class="popular-post-grids">
											
												<div class="popular-post-grid" id="${l2[sta1.index].className }">
													
													<div class="post-img">
														<a href="Front?op=displayNews&newsId=${news2.newsId}">
														<img src="images/${news2.pictures }" alt="" /></a>
													</div>
													<div class="post-text">
														<a class="pp-title" href="Front?op=displayNews&newsId=${news2.newsId}">
														${news2.headTitle }</a>
													</div>
													<div class="clearfix"></div>
